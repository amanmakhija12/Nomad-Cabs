...
const TransactionDetailModal = ({ transaction, onClose, userRole }) => {
  ...
  const rideFareSubtotal =
    (transaction.baseFare || 0) +
    ...
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      >
        <div className="flex justify-between items-center p-6 border-b border-white/10">
          ...
          <button
            onClick={onClose}
            className="h-9 w-9 flex items-center justify-center rounded-full text-white/60 hover:text-white hover:bg-white/10 transition"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto">
          <div className="bg-[#1f1f1f] rounded-xl border border-white/10 p-5">
            ...
            <div className="space-y-1">
              ...
              {isRider ? (
                ...
                <>
                  <FareRow
                    label="Ride Fare Subtotal"
                    value={rideFareSubtotal}
                    isTotal
                  />
                  <FareRow
          ...
          <div className="bg-[#1f1f1f] rounded-xl border border-white/10 p-5">
            ...
            <div className="space-y-1">
              ...
              <InfoRow
                label="Date"
                value={formatDateSafe(transaction.createdAt)}
              />
              <InfoRow
              ...
              <InfoRow
                ...
                value={transaction.bookingStatus}
              />
            </div>
          </div>
        </div>
