...
const Wallet = () => {
  ...
  const inputBase =
    "w-full h-12 px-4 rounded-xl bg-[#1a1a1a] border border-white/10 text-white placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-white/20";
        ...
        {loading ? (
          ...
          <div className="bg-[#141414] rounded-2xl p-12 text-center border border-red-500/30">
            ...
            <p className="text-gray-400 mt-2">
              We could not find a wallet for your account. Please contact
              support.
            </p>
          </div>
        ) : (
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="text-left">
          ...
          <p className="text-xs text-white/50">
            {formatDateSafe(tx.timestamp, { variant: "datetime" })}
          </p>
        </div>
      </div>
      <div className={`text-lg font-semibold ${color}`}>{amount}</div>
    </button>
  );
};
